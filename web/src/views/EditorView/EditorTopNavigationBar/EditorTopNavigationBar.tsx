...
const EditorTopNavigationBar: React.FC<IProps> = ({ activeContext, updateImageDragModeStatus, imageDragMode, activeLabelType, enableNavigationBar }) => {
    ...
    const getClassName = () => {
        return classNames(
            ...
            {
                'hideNavigationBar': enableNavigationBar === false
            }
        );
    };
